...
import org.fife.ui.rtextarea.RTextScrollPane;
     ...
     * @version 1.0
     */
    public class DemoCodeEditor extends JRootPane implements HyperlinkListener,
            SyntaxConstants {
...
//errorStrip.setBackground(java.awt.Color.blue);
        ...
        private static Action createCopyAsStyledTextAction(String themeName) throws IOException {
            ...
            Theme theme = Theme.load(DemoCodeEditor.class.getResourceAsStream(resource));
        ...
        private class AboutAction extends AbstractAction {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(DemoCodeEditor.this,
        ...
        public static void main (String args[]) {
            ...
            jFrame.setContentPane(new DemoCodeEditor());
